...
public class Carreras {
    ...
    public static void verCoches(ArrayList<Coches> coche)  {
        ...
        if (posicion < 0){
            System.out.println("Coche no existe." + marcaCoche);
    ...
    public static void buscarMatricula (ArrayList<Coches> coche) {
        boolean existe = false;
        ...
        matriculaCoche = captura.nextLine();

        while (!existe && i < coche.size()) {

            if (matriculaCoche.equalsIgnoreCase(coche.get(i).getMatriculaCoche())) {
                posic = i;
                existe = true;
            }
            i++;
        ...
        if (posic < 0) {
            System.out.println("El coche no está en el circuito, Matricula: " + matriculaCoche);

        } else {
            System.out.println("Marca Coche:" + coche.get(posic).getMarcaCoche());
            System.out.println("Modelo Coche:" + coche.get(posic).getModeloCoche());
            System.out.println("Potencia Coche:" + coche.get(posic).getPotenciaCoche());
            System.out.println("Cilidrada Coche:" + coche.get(posic).getCilidandraCoche());
            System.out.println("Matricula Coche:" + coche.get(posic).getMatriculaCoche());
        }
